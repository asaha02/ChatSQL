...
radio_opt=["Use SQLLite 3 Database- Chinook.db","Connect to you MySQL Database"]
...
## LLM model
llm=ChatOpenAI(openai_api_key=api_key,model="gpt-3.5-turbo", temperature=0, streaming=True)
